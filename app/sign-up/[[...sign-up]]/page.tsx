      ...
      <div className="grid w-full max-w-5xl gap-5 lg:grid-cols-[0.9fr_1.1fr]">
        <Card className="bubble-field min-h-[560px]">
          <div className="relative z-10">
            ...
            <Pill active className="mt-10">Create account</Pill>
            <h1 className="mt-6 max-w-md text-5xl font-black tracking-normal">Start splitting cleanly</h1>
            <p className="mt-4 max-w-md text-lg leading-7 text-ink/65">
              Create a Clerk-backed account and land directly in the Evenly dashboard.
            </p>
          </div>
        </Card>
